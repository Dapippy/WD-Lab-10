...
function validate() {
	var sid = $("#sid").val();													//Originally document.getElementById("sid").value; 
	var pwd1 = $("#pwd1").val();												//Originally document.getElementById("pwd1").value;
	var pwd2 = $("#pwd2").val();												//Originally document.getElementById("pwd2").value;
	var uname = $("#uname").val();												//Originally document.getElementById("uname").value; 
	var genm = $("#genm").prop("checked");										//Originally document.getElementById("genm").checked; 
	var genf = $("#genf").prop("checked");										//Originally document.getElementById("genf").checked; 
	...
	if ((!genm) && (!genf)) {				//check whether gender is selected //replaced (genm == "")&&(genf == "")
...
/*Function to collapse and expand sections */
function toggle(){
...
function init () {
	...
	//originally var regForm = document.getElementById("regform");


	$(".collapse").click(toggle);
	/* link function validate() to the onsubmit event of the form */
	$("#regform").submit(validate);			//originally regForm.onsubmit = validate;
}

/* execute function init() once the window is loaded*/
$(document).ready(init);			//originally window.onload = init;